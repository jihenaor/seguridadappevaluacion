 ...
 */
public class MyQuizteoricorespuestaRecyclerViewAdapter extends RecyclerView.Adapter<MyQuizteoricorespuestaRecyclerViewAdapter.ViewHolder> {

    private final List<DummyItem> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MyQuizteoricorespuestaRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
